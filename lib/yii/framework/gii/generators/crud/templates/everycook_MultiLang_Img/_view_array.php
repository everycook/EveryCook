...
<?php echo "<?php\n"; ?>
	if ($this->isFancyAjaxRequest){
		echo '<div class="list_img">';
			echo CHtml::image($this->createUrl('<?php echo $this->controller; ?>/displaySavedImage', array('id'=>$data['REC_ID'], 'ext'=>'.png')), '', array('class'=>'<?php echo $this->controller; ?>', 'alt'=>$data['REC_DESC_' . Yii::app()->session['lang']], 'title'=>$data['REC_DESC_' . Yii::app()->session['lang']]));
			echo '<div class="img_auth">';
			if ($data['<?php echo $tablePrefix; ?>_IMG_ETAG'] == '') { echo '&nbsp;'; } else {echo '© by ' . $data['<?php echo $tablePrefix; ?>_IMG_AUTH']; } 
			echo '</div>';
		echo '</div>';
		...
		echo '<div class="list_img">';
			echo CHtml::link(CHtml::image($this->createUrl('<?php echo $this->controller; ?>/displaySavedImage', array('id'=>$data['<?php echo $primaryKey; ?>'], 'ext'=>'.png')), '', array('class'=>'<?php echo $this->controller; ?>', 'alt'=>$data['<?php echo $tablePrefix; ?>_DESC_' . Yii::app()->session['lang']], 'title'=>$data['<?php echo $tablePrefix; ?>_DESC_' . Yii::app()->session['lang']])), array('view', 'id'=>$data['<?php echo $primaryKey; ?>'])); 
			echo '<div class="img_auth">';
			if ($data['<?php echo $tablePrefix; ?>_IMG_ETAG'] == '') { echo '&nbsp;'; } else {echo '© by ' . $data['<?php echo $tablePrefix; ?>_IMG_AUTH']; } 
			echo '</div>';
		echo '</div>';

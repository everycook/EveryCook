...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	*/
	...
	<div class="row">
		<?php echo $form->labelEx($model,'STO_GPS'); ?>
		<?php echo $form->textField($model,'STO_GPS',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'STO_GPS'); ?>
	</div>
...
<?php /*
	...
	*/ ?> 
	...
	<div class="row buttons">
		...
		<?php echo CHtml::submitButton('Address to GPS', array('name'=>'Address_to_GPS', 'class'=>'button')); ?>
		<?php echo CHtml::submitButton('GPS to Address', array('name'=>'GPS_to_Address', 'class'=>'button')); ?>
	</div>

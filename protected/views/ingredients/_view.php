<div class="view">
	...
	<?php echo CHtml::encode($data->ING_GROUP); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('ING_SUBGROUP')); ?>:</b>
	<?php echo CHtml::encode($data->ING_SUBGROUP); ?>
	<br />
	...
	*/?>
	...
	<!-- STL show image -->
	<?php echo CHtml::image($this->createUrl('ingredients/displaySavedImage', array('id'=>$data->ING_ID))); ?><br />

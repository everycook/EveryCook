...
<div class="detailView" id="products">
	...
	<div>
		<div class="options">
			...
			<div class="ingredients otherItems">
				...
				echo '<div class="item">';
					...
					echo '<div class="small_img">';
						echo CHtml::link(CHtml::image($this->createUrl('ingredients/displaySavedImage', array('id'=>$model->ingredient['ING_ID'], 'ext'=>'.png')), $model->ingredient['ING_NAME_' . Yii::app()->session['lang']], array('class'=>'ingredient', 'title'=>$model->ingredient['ING_NAME_' . Yii::app()->session['lang']])), array('ingredients/view', 'id'=>$model->ingredient['ING_ID']));
						echo '<div class="img_auth">';
		...
		<div class="detail_img f-left">
			<?php echo CHtml::image($this->createUrl('products/displaySavedImage', array('id'=>$model->PRO_ID, 'ext'=>'.png')), $model->__get('PRO_NAME_' . Yii::app()->session['lang']), array('class'=>'product', 'title'=>$model->__get('PRO_NAME_' . Yii::app()->session['lang']))); ?>

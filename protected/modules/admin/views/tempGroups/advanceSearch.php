...
if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseTempGroups'); ?>"/>
	<?php
}
?>

<div id="temp-groupsAdvanceSearch">
...
/*	
	...
	<div class="row">
		<?php echo $form->label($model,'TGR_ID'); ?>
		<?php echo $form->textField($model,'TGR_ID'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'TGR_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'TGR_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'TGR_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'TGR_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
	</div>

...
$this->menu=array(
	array('label'=>'Create CookingStove', 'url'=>array('create')),
	array('label'=>'Manage CookingStove', 'url'=>array('admin')),
);
...
if (isset(Yii::app()->session['CookingStove']) && isset(Yii::app()->session['CookingStove']['time'])){
	$advanceSearch=array_merge($advanceSearch,array('newSearch'=>Yii::app()->session['CookingStove']['time']));
}

if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseCookingStove'); ?>"/>
	<?php
}
?>

<div id="cooking-stoveAdvanceSearch">
<?php  $form=$this->beginWidget('CActiveForm', array(
		'action'=>Yii::app()->createUrl($this->route),
		'method'=>'post',
		'id'=>'cooking-stove_form',
...
/*	
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'COS_ID'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'COS_MANUFACTURE'); ?>
		<?php echo $form->textField($model,'COS_MANUFACTURE',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'COS_MODEL'); ?>
		<?php echo $form->textField($model,'COS_MODEL',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'COS_LEVELS'); ?>
		<?php echo $form->textField($model,'COS_LEVELS'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'COS_CONTINIOUS'); ?>
		<?php echo $form->textField($model,'COS_CONTINIOUS',array('size'=>1,'maxlength'=>1)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'COS_MAESUREMENT'); ?>
		<?php echo $form->textField($model,'COS_MAESUREMENT',array('size'=>60,'maxlength'=>100)); ?>
	</div>

...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	echo '<div class="row">'."\r\n";
		echo $form->labelEx($model,'DIE_DESC_'.$lang) ."\r\n";
		echo $form->textField($model,'DIE_DESC_'.$lang,array('size'=>60,'maxlength'=>100)) ."\r\n";
		echo $form->error($model,'DIE_DESC_'.$lang) ."\r\n";
	echo '</div>'."\r\n";
	}
	...
	*/
	...
	<div class="row">
		<?php echo $form->labelEx($model,'DIE_VALUES'); ?>
		<?php echo $form->textField($model,'DIE_VALUES',array('size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'DIE_VALUES'); ?>
	</div>

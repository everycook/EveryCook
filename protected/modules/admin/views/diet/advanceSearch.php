...
if (isset(Yii::app()->session['Diet']) && isset(Yii::app()->session['Diet']['time'])){
	$advanceSearch=array_merge($advanceSearch,array('newSearch'=>Yii::app()->session['Diet']['time']));
}

if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseDiet'); ?>"/>
	<?php
}
?>

<div id="dietAdvanceSearch">
...
/*	
	...
	<div class="row">
		<?php echo $form->label($model,'DIE_ID'); ?>
		<?php echo $form->textField($model,'DIE_ID'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'DIE_VALUES'); ?>
		<?php echo $form->textField($model,'DIE_VALUES',array('size'=>60,'maxlength'=>200)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'DIE_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'DIE_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'DIE_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'DIE_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
	</div>

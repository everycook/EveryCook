...
if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseCookIn'); ?>"/>
	<?php
}
?>

<div id="cook-inAdvanceSearch">
...
/*	
	...
	<div class="row">
		<?php echo $form->label($model,'COI_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'COI_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'COI_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'COI_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
	</div>

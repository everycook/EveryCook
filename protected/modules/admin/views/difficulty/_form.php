...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	echo '<div class="row">'."\r\n";
		echo $form->labelEx($model,'DIF_DESC_'.$lang) ."\r\n";
		echo $form->textField($model,'DIF_DESC_'.$lang,array('size'=>60,'maxlength'=>100)) ."\r\n";
		echo $form->error($model,'DIF_DESC_'.$lang) ."\r\n";
	echo '</div>'."\r\n";
	}
	...
	*/
	...
	<div class="row">
		<?php echo $form->labelEx($model,'DIF_ID'); ?>
		<?php echo $form->textField($model,'DIF_ID'); ?>
		<?php echo $form->error($model,'DIF_ID'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'DIF_ORDER'); ?>
		<?php echo $form->textField($model,'DIF_ORDER'); ?>
		<?php echo $form->error($model,'DIF_ORDER'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'DIF_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'DIF_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'DIF_DESC_EN_GB'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'DIF_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'DIF_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'DIF_DESC_DE_CH'); ?>
	</div>

...
$this->menu=array(
	...
	array('label'=>'Update CusineSubTypes', 'url'=>array('update', 'id'=>$model->CST_ID)),
	array('label'=>'Delete CusineSubTypes', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->CST_ID),'confirm'=>'Are you sure you want to delete this item?')),
...
<h1><?php printf($this->trans->TITLE_CUSINESUBTYPES_VIEW, $model->CST_ID); ?></h1><div class="f-center">
	<?php

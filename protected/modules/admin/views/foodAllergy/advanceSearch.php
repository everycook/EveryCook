...
$this->menu=array(
	array('label'=>'Create FoodAllergy', 'url'=>array('create')),
	array('label'=>'Manage FoodAllergy', 'url'=>array('admin')),
);
...
if (isset(Yii::app()->session['FoodAllergy']) && isset(Yii::app()->session['FoodAllergy']['time'])){
	$advanceSearch=array_merge($advanceSearch,array('newSearch'=>Yii::app()->session['FoodAllergy']['time']));
}

if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseFoodAllergy'); ?>"/>
	<?php
}
?>

<div id="food-allergyAdvanceSearch">
<?php  $form=$this->beginWidget('CActiveForm', array(
		'action'=>Yii::app()->createUrl($this->route),
		'method'=>'post',
		'id'=>'food-allergy_form',
...
/*	
	...
	<div class="row">
		<?php echo $form->label($model,'FAL_ID'); ?>
		<?php echo $form->textField($model,'FAL_ID'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'FAL_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'FAL_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'FAL_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'FAL_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
	</div>

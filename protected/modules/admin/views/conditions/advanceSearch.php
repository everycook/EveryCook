...
if (isset(Yii::app()->session['Conditions']) && isset(Yii::app()->session['Conditions']['time'])){
	$advanceSearch=array_merge($advanceSearch,array('newSearch'=>Yii::app()->session['Conditions']['time']));
}

if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseConditions'); ?>"/>
	<?php
}
?>

<div id="conditionsAdvanceSearch">
...
/*	
	...
	<div class="row">
		<?php echo $form->label($model,'CND_ID'); ?>
		<?php echo $form->textField($model,'CND_ID'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'CND_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'CND_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'CND_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'CND_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
	</div>

...
if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseActionsOut'); ?>"/>
	<?php
}
?>

<div id="actions-outAdvanceSearch">
...
/*	
	...
	<div class="row">
		<?php echo $form->label($model,'AOU_ID'); ?>
		<?php echo $form->textField($model,'AOU_ID'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'AOU_PREP'); ?>
		<?php echo $form->textField($model,'AOU_PREP',array('size'=>1,'maxlength'=>1)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'AOU_DURATION'); ?>
		<?php echo $form->textField($model,'AOU_DURATION'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'AOU_DUR_PRO'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'AOU_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'AOU_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'AOU_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'AOU_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
	</div>

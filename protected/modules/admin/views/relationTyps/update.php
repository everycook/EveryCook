...
$this->breadcrumbs=array(
	...
	$model->REL_ID=>array('view','id'=>$model->REL_ID),
	'Update',
);
...
$this->menu=array(
	...
	array('label'=>'View RelationTyps', 'url'=>array('view', 'id'=>$model->REL_ID)),
	array('label'=>'Manage RelationTyps', 'url'=>array('admin')),
);
?>

<h1><?php printf($this->trans->TITLE_RELATIONTYPS_UPDATE, $model->REL_ID); ?></h1>

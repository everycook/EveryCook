...
if (isset(Yii::app()->session['RelationTyps']) && isset(Yii::app()->session['RelationTyps']['time'])){
	$advanceSearch=array_merge($advanceSearch,array('newSearch'=>Yii::app()->session['RelationTyps']['time']));
}

if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseRelationTyps'); ?>"/>
	<?php
}
?>

<div id="relation-typsAdvanceSearch">
<?php  $form=$this->beginWidget('CActiveForm', array(
		'action'=>Yii::app()->createUrl($this->route),
		'method'=>'post',
		'id'=>'relation-typs_form',
...
/*	
	...
	<div class="row">
		<?php echo $form->label($model,'REL_ID'); ?>
		<?php echo $form->textField($model,'REL_ID'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'REL_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'REL_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'REL_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'REL_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
	</div>

...
if (isset(Yii::app()->session['Tags']) && isset(Yii::app()->session['Tags']['time'])){
	$advanceSearch=array_merge($advanceSearch,array('newSearch'=>Yii::app()->session['Tags']['time']));
}

if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseTags'); ?>"/>
	<?php
}
?>

<div id="tagsAdvanceSearch">
...
/*	
	...
	<div class="row">
		<?php echo $form->label($model,'TAG_IGNORE'); ?>
		<?php echo $form->textField($model,'TAG_IGNORE',array('size'=>1,'maxlength'=>1)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'TAG_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'TAG_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'TAG_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'TAG_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
	</div>

...
if (isset(Yii::app()->session['CusineSubSubTypes']) && isset(Yii::app()->session['CusineSubSubTypes']['time'])){
	$advanceSearch=array_merge($advanceSearch,array('newSearch'=>Yii::app()->session['CusineSubSubTypes']['time']));
}

...
if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('advanceChooseCusineSubSubTypes'); ?>"/>
	<?php
}
?>

<div id="cusine-sub-sub-typesAdvanceSearch">
...
/*	
	...
	<div class="row">
		<?php echo $form->label($model,'CSS_ID'); ?>
		<?php echo $form->textField($model,'CSS_ID'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'CSS_GPS_LAT'); ?>
		<?php echo $form->textField($model,'CSS_GPS_LAT'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'CSS_GPS_LNG'); ?>
		<?php echo $form->textField($model,'CSS_GPS_LNG'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'CSS_GOOGLE_REGION'); ?>
		<?php echo $form->textField($model,'CSS_GOOGLE_REGION',array('size'=>50,'maxlength'=>50)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'CSS_IMG_FILENAME'); ?>
		<?php echo $form->textField($model,'CSS_IMG_FILENAME',array('size'=>60,'maxlength'=>250)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'CSS_IMG_ETAG'); ?>
		<?php echo $form->textField($model,'CSS_IMG_ETAG',array('size'=>40,'maxlength'=>40)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'CSS_DESC_EN_GB'); ?>
		<?php echo $form->textField($model,'CSS_DESC_EN_GB',array('size'=>60,'maxlength'=>100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'CSS_DESC_DE_CH'); ?>
		<?php echo $form->textField($model,'CSS_DESC_DE_CH',array('size'=>60,'maxlength'=>100)); ?>
	</div>

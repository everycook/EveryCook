...
if (isset(Yii::app()->session['Feedbacks']) && isset(Yii::app()->session['Feedbacks']['time'])){
	$advanceSearch=array_merge($advanceSearch,array('newSearch'=>Yii::app()->session['Feedbacks']['time']));
}

if ($this->isFancyAjaxRequest){ ?>
	<input type="hidden" id="FancyChooseSubmitLink" value="<?php echo $this->createUrl('chooseFeedbacks'); ?>"/>
	<?php
}
?>

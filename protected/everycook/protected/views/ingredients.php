...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'ingredients-ingredients-form',
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'ING_TITLE_EN'); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'ING_PICTURE_AUTH'); ?>
		<?php echo $form->error($model,'ING_PICTURE_AUTH'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'ING_TITLE_DE'); ?>
		<?php echo $form->textField($model,'ING_TITLE_DE'); ?>

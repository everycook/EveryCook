...
/**
 * This is the model class for table "ing_to_fal".
 *
 * The followings are the available columns in table 'ing_to_fal':
 * @property integer $ING_ID
 * @property integer $FAL_ID
 * @property integer $CREATED_BY
 * @property integer $CREATED_ON
 * @property integer $CHANGED_BY
 * @property integer $CHANGED_ON
 */
class IngToFal extends ActiveRecordEC
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return IngToFal the static model class
	 */
	...
	public function rules(){
		...
		return array(
			array('ING_ID, FAL_ID, CREATED_BY, CREATED_ON, CHANGED_BY, CHANGED_ON', 'required'),
			array('ING_ID, FAL_ID, CREATED_BY, CREATED_ON, CHANGED_BY, CHANGED_ON', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ING_ID, FAL_ID, CREATED_BY, CREATED_ON, CHANGED_BY, CHANGED_ON', 'safe', 'on'=>'search'),
		);
	}
	...
	public function getCriteriaString(){
		...
		$criteria->compare($this->tableName().'.FAL_ID',$this->FAL_ID);
	...
	public function getCriteria(){
		...
		$criteria->compare('FAL_ID',$this->FAL_ID);

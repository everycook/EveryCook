...
class EcologyController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Ecology');
	...
	{
		$model=new Ecology('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ecology']))
			$model->attributes=$_GET['Ecology'];
	...
	{
		$model=Ecology::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ecology-form')
		{

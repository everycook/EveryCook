...
class Ingredients2Controller extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Ingredients2'];
	...
	{
		$model=Ingredients2::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ingredients2-form')
		{
